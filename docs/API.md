...
See [Configuration](CONFIGURATION.md) for the full list of environment variables (`ADMIN_TOKEN`, `DB_URL`) and how they differ between local dev, Docker, and Kubernetes.
